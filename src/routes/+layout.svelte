			...
			<div class="flex justify-between items-center h-24">
				...
				<div class="flex items-center space-x-6">
					...
					<div class="relative group">
						...
						></div>
						<div
							class="relative flex items-center space-x-4 bg-white/5 px-5 py-3 rounded-xl backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all duration-300"
						>
							<!-- Avatar with Status -->
							<div class="relative">
								<div
